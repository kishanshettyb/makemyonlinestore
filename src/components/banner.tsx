...
export function Banner() {
	...
	return (
		<div className="w-3/5 mt-20">
			...
			<p className="text-xl opacity-50 mx-14 mb-7">Make My Online Store takes care of everything from design to launch. Get your store up and running in just days!</p>
